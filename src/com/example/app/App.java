...
public class App {
	public static String[] performanceParameters = { "Creativity", "Communication", "TechnicalSkills", "PersonalHabits",
			"TakeInitiative" };
	...
	public static void main(String[] args) {
		...
		HR hr = new HR();
		 ...
		 hr.parameterTopper(listOfEmployees, parameters, performanceParameters[4]);
